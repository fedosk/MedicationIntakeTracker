...
import { Image, ActivityIndicator, StyleSheet, View, ImageProps, ImageStyle } from "react-native";
...
const UniversalImage: React.FC<UniversalImageProps> = ({
	...
	return (
		<View style={[styles.container, style]}>
			{loading && !error ? (
				<ActivityIndicator size={loadingIndicatorSize} style={styles.loadingIndicator} />
			) : null}
